    ...
    >
      <div className="aspect-square bg-gradient-to-br from-primary/20 to-secondary/20 rounded-lg overflow-hidden relative bg-black w-1/2 h-1/2">
        <Image
          ...
          fill
          className="object-cover hover:scale-105 transition-transform duration-300 shadow w-1/2 h-1/2"
          sizes="(max-width: 768px) 100vw, 33vw "
          priority
        />
      </div>
      <div className="bg-card border border-primary/20 shadow-lg rounded-lg w-1/2">
        <div className="p-8">
